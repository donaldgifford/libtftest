...
func TestContainerStart_ImageOverride(t *testing.T) {
	...
	t.Setenv("LIBTFTEST_LOCALSTACK_IMAGE", "localstack/localstack:4.14")
	...
	if got != "localstack/localstack:4.14" {
		t.Errorf("ResolveImage() = %q, want localstack/localstack:4.14", got)
	}
