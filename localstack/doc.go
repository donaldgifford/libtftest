...
//     localstack/localstack:2026.07.4) requires an auth token even
...
//     a token it falls back to the last token-free community image,
//     localstack/localstack:4.14. LIBTFTEST_LOCALSTACK_IMAGE or
